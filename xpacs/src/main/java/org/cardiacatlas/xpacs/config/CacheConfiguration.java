...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(org.cardiacatlas.xpacs.domain.User.class.getName(), jcacheConfiguration);
            cm.createCache(org.cardiacatlas.xpacs.domain.Authority.class.getName(), jcacheConfiguration);
            cm.createCache(org.cardiacatlas.xpacs.domain.User.class.getName() + ".authorities", jcacheConfiguration);
            ...
            cm.createCache(org.cardiacatlas.xpacs.domain.SecondPatientInfo.class.getName(), jcacheConfiguration);
