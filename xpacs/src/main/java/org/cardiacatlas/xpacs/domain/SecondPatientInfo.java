...
public class SecondPatientInfo implements Serializable {
    ...
    public SecondPatientInfo patient_id(String patient_id) {
    ...
    public SecondPatientInfo cohort(String cohort) {
        this.cohort = cohort;
        return this;
    }
    ...
    public SecondPatientInfo ethnicity(String ethnicity) {
    ...
    public SecondPatientInfo gender(GenderType gender) {
        this.gender = gender;
        return this;
    }
    ...
    public SecondPatientInfo primary_diagnosis(String primary_diagnosis) {
    ...
    public boolean equals(Object o) {
        ...
        SecondPatientInfo patientInfo = (SecondPatientInfo) o;
