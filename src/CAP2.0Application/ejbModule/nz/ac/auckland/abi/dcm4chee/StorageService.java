...
public class StorageService extends DcmServiceBase {
    ...
    private Vector<StorageServiceEventListener> eventListeners = new Vector<StorageServiceEventListener>();
    ...
    public void doCStore(ActiveAssociation assoc, Dimse rq, Command rspCmd) throws IOException {
        ...
        objFact.newFileMetaInfo(rqCmd.getAffectedSOPClassUID(), rqCmd.getAffectedSOPInstanceUID(), rq.getTransferSyntaxUID());
        ...
        if (rspDelay > 0L) {
            try {
            	...
            	java.util.logging.Logger.getLogger(this.getClass().getSimpleName()).log(java.util.logging.Level.WARNING,ie.getMessage());
            }
        }
